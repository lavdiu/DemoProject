...
use Lavdiu\DemoApp\PersonType;
use Laf\Exception\InvalidForeignKeyValue;

/**
 * Class BasePersonType
 * @package Lavdiu\DemoApp\Base
 * Base Class for Table person_type
 * Basic definition of the fields and relationship with the Database Table person_type
 ...
 */
class BasePersonType extends Database\BaseObject
{
	/**
	...
	{
		$this->setTable(new Table('person_type'));
		/**
		 * Generate field data
		 */
		$pk = new PrimaryKey();
