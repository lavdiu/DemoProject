...
/**
 * Class BaseRecordStatus
 * @package Lavdiu\DemoApp\Base
 * Base Class for Table record_status
 * Basic definition of the fields and relationship with the Database Table record_status
 ...
 */
class BaseRecordStatus extends Database\BaseObject
{
	/**
	...
	{
		$this->setTable(new Table('record_status'));
		/**
		 * Generate field data
		 */
		$pk = new PrimaryKey();
