 ...
 * Base Class for Table ticket_status
 * Basic definition of the fields and relationship with the Database Table ticket_status
 ...
 */
class BaseTicketStatus extends Database\BaseObject
{
	/**
	...
	{
		$this->setTable(new Table('ticket_status'));
		/**
		 * Generate field data
		 */
		$pk = new PrimaryKey();
