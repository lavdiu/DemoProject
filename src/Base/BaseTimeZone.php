...
use Lavdiu\DemoApp\TimeZone;
use Laf\Exception\InvalidForeignKeyValue;

/**
 * Class BaseTimeZone
 * @package Lavdiu\DemoApp\Base
 * Base Class for Table time_zone
 * Basic definition of the fields and relationship with the Database Table time_zone
 ...
 */
class BaseTimeZone extends Database\BaseObject
{
	/**
	...
	{
		$this->setTable(new Table('time_zone'));
		/**
		 * Generate field data
		 */
		$pk = new PrimaryKey();
