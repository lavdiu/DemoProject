...
use Lavdiu\DemoApp\TicketCategory;
use Laf\Exception\InvalidForeignKeyValue;

/**
 * Class BaseTicketCategory
 * @package Lavdiu\DemoApp\Base
 * Base Class for Table ticket_category
 * Basic definition of the fields and relationship with the Database Table ticket_category
 ...
 */
class BaseTicketCategory extends Database\BaseObject
{
	/**
	...
	{
		$this->setTable(new Table('ticket_category'));
		/**
		 * Generate field data
		 */
		$pk = new PrimaryKey();
