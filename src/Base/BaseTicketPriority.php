...
use Lavdiu\DemoApp\TicketPriority;
use Laf\Exception\InvalidForeignKeyValue;

/**
 * Class BaseTicketPriority
 * @package Lavdiu\DemoApp\Base
 * Base Class for Table ticket_priority
 * Basic definition of the fields and relationship with the Database Table ticket_priority
 ...
 */
class BaseTicketPriority extends Database\BaseObject
{
	/**
	...
	{
		$this->setTable(new Table('ticket_priority'));
		/**
		 * Generate field data
		 */
		$pk = new PrimaryKey();
