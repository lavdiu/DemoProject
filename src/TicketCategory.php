 ...
 * Main Class for Table ticket_category
 * This class inherits functionality from BaseTicketCategory.
 * It is generated only once, please include all logic and code here
 */
class TicketCategory extends Base\BaseTicketCategory
{
	/**
	 ...
	 * @throws \Exception
	 */
	public static function findOne(array $keyValuePairs) : ?TicketCategory
	{
