 ...
 * Main Class for Table backups_hourly
 * This class inherits functionality from BaseBackupsHourly.
 * It is generated only once, please include all logic and code here
 */
class BackupsHourly extends Base\BaseBackupsHourly
{
	/**
	 ...
	 * @throws \Exception
	 */
	public static function findOne(array $keyValuePairs) : ?BackupsHourly
	{
